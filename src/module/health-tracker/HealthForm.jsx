    ...
    <Container>
      <div className="flex flex-row justify-between items-center mt-6 border border-slate-700/40 p-6 rounded-2xl">
        ...
        <div className="dropdown dropdown-bottom dropdown-center ml-4 w-1/6 relative">
          ...
          >
            <li>
              <a onClick={() => setInputType("Calories")}>Calories</a>
            </li>
            <li>
              <a onClick={() => setInputType("Sugar")}>Sugar</a>
            </li>
            <li>
              <a onClick={() => setInputType("Water")}>Water</a>
            </li>
            <li>
              <a onClick={() => setInputType("Condition")}>Condition</a>
            </li>
          </ul>
        </div>
        ...
        <div className="ml-4 w-1/3">
          <fieldset className="relative border border-base-800 rounded-lg px-4 pt-2 py-3 mb-1.5">
            <legend className="px-1 text-sm text-base-800 mb-0">
              Description
            </legend>
            <input
              type="text"
