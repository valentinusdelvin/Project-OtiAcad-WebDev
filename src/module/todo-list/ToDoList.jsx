                ...
                <div className='flex flex-row md:gap-4 gap-2 items-center'>
                    <div className="flex">
                        <button
                            ...
                            todo.completed ? "btn-circle btn-ghost hover:btn-success transition-all duration-200" : "btn-circle btn-ghost hover:btn-success transition-all duration-200"
                            }`}
                        >
                    ...
                    <span className="flex flex-row gap-2 text-xs text-gray-400 mt-1">
                        <Calendar className='h-4 w-4' /> {todo.createdAt.toLocaleString()}
                    </span>
                    </div>
                </div>
